public static class ArraysTester
{
    ...
    {
        // Store multiples in an empty array
        double[] multiples = new double[length];

        // Create a loop to loop through the multiples
        for (int i = 0; i < length; i++)
        {
            // Calculate then add multiples to the array
    ...
    {
        // Set the effective rotation amount
        int effectiveAmount = amount % data.Count;

        // Take out the elements to be rotated
